...
class AutumnWoodsPile {
  static ID = 'autumn-woods-pile';
  ...
  static TEMPLATES = {
    LIFESTEAL: Template.named("lifesteal")
  }
...
Hooks.on("renderItemSheet5e", (app, html, data) => {
  // console.log("===================== AUTUMN-WOODS RENDER ITEM SHEET =====================");
  // console.log(app);
  ...
  //   await item.update({"system.properties.lifesteal": checked});
  // })
